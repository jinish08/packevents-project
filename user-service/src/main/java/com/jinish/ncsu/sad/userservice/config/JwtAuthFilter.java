package com.jinish.ncsu.sad.userservice.config; // Adjust package for each service

import com.jinish.ncsu.sad.userservice.service.JwtService; // Adjust import for each service
